...
namespace TheEWL
{
    public partial class TestListenFind : UserControl
    {
        ...
        public TestListenFind()
        {
            InitializeComponent();
        }
        private static TestListenFind _instance;
        public static TestListenFind Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new TestListenFind();
                return _instance;
            }
        ...
        void ButtonClickQ(object sender, EventArgs e)
        {
            ...
            if (Betton != null)
            {
                ...
                if ((string)btnPlay.Tag == z.getWord())
                {
                    Q(true);
        ...
        private void Q(bool sonuc)
        {
            switch (CurrID)
            {
                ...
                case 10:
                    ...
                    MainTests.Instance.NextTest("TestListenWrite");
                    break;
            }
        }
